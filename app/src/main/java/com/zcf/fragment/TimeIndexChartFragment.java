...
public class TimeIndexChartFragment extends Fragment {
    ...
    private void showKChart(Message msg) {
        ...
        ImageView iv_timeIndexKChart = rootView.findViewById(R.id.fragment_time_index_kchart);
        iv_timeIndexKChart.setImageBitmap(bitmap);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // 缓存优化
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_timeindexchart, null);
            initKChart();
        }
