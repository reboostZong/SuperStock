...
public class DailyKChartFragment extends Fragment {
    ...
    private void showKChart(Message msg) {
        ...
        ImageView iv_dailyKChart = rootView.findViewById(R.id.fragment_daily_kchart);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // 缓存优化
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_dailykchart, null);
            initKChart();
        }
    ...
    private void initKChart() {
        ...
        String url = SuperStockConstant.DAILY_KCHART_URL + stockPrefix + stockNum + ".gif";
