...
public class WeeklyKChartFragment extends Fragment {
    ...
    private void showKChart(Message msg) {
        ...
        ImageView iv_weeklyKChart = rootView.findViewById(R.id.fragment_weekly_kchart);
        iv_weeklyKChart.setImageBitmap(bitmap);
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        // 缓存优化
        if (rootView == null) {
            rootView = inflater.inflate(R.layout.fragment_weeklykchart, null);
            initKChart();
        }
    ...
    private void initKChart() {
        ...
        String url = SuperStockConstant.WEEKLY_KCHART_URL + stockPrefix + stockNum + ".gif";
