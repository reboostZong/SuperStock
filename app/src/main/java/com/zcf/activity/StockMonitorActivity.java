...
import com.zcf.fragment.TimeIndexChartFragment;
...
public class StockMonitorActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stockmonitor);
    ...
    private void registServiceBroadcast() {
        ...
        intentFilter.addAction("superstock.service."+ stockNum);
    ...
    private void initData() {
        ...
        // 获取股票前缀
        this.stockPrefix = getIntent().getStringExtra("stockPrefix");
        // 获取监控状态
        this.isMonitor = getIntent().getBooleanExtra("isMonitor", true);
     ...
     * @param stock stock
     */
    private void showStockUI(Stock stock) {
        View titleBar = findViewById(R.id.stockmonitor_titlebar);
        TextView tv_title = titleBar.findViewById(R.id.titlebar_title);
        // 设置股票名称
        tv_title.setText(stock.getStockName());

        View stockPreview = findViewById(R.id.stockmonitor_stock_resume);
        ...
        View buy5Sell5 = findViewById(R.id.stockmonitor_buy5sell5);
        ...
        // 分时图
        final ImageView iv_timeIndexChart = findViewById(R.id.stockmonitor_time_index_chart);
        ...
        Glide.with(StockMonitorActivity.this)
                .load(url)
                .asBitmap()
    ...
    private void initTitleBar() {
        ...
        imgbtn_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(StockMonitorActivity.this, MainActivity.class);
    ...
    private void initKChart() {
        View kChart = findViewById(R.id.stockmonitor_kchart);
        final FragmentTabHost fragmentTabHost = kChart.findViewById(R.id.kchart_tabhost);
        fragmentTabHost.setup(StockMonitorActivity.this, getSupportFragmentManager(), R.id.kchart_content);
        fragmentTabHost.getTabWidget().setDividerDrawable(null);
        Bundle bundle = new Bundle();
        bundle.putString("stockPrefix", stockPrefix);
        bundle.putString("stockNum", stockNum);
        fragmentTabHost.addTab(fragmentTabHost.newTabSpec("分时").setIndicator(createViewComponent("分时")), TimeIndexChartFragment.class, bundle);
    ...
    private class ServiceReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (("superstock.service."+stockNum).equals(intent.getAction())) {
                // 收到service的消息
